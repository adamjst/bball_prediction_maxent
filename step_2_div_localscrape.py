...
def step2_scrape(league, year_start, years_back):
    ...
    for yr in yrs:
            ...
            for t in table:
                ...
                for t in teams:
                    ...
                    for s in spots:
                        ...
                        if re.match(r'\w+.(Division)', clean_team) or len(out_divisions) == 0:
        ...
        #print(teams_df3)
        teams_df3.to_csv((step2_csv), header=True)

# # # Run for each league during league's years of operation
#step2_scrape('WNBA', '', 2019, 23)
step2_scrape('NBA', 2019, 71)
step2_scrape('ABA', 1975, 8)
step2_scrape('BAA', 1949, 3)
